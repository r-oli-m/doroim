...
import { getFirestore, collection, doc, addDoc, updateDoc, query, where, getDocs } from 'firebase/firestore'; // Import Firestore functions
...
const JoinGroup = () => {
    ...
    const handleJoinGroup = async (e) => {
        ...
        try {
            ...
            const q = query(collection(firestore, 'groups'), where('permissionCode', '==', permissionCode));
